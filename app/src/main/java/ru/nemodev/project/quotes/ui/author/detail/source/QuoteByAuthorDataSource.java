package ru.nemodev.project.quotes.ui.author.detail.source;
...
public class QuoteByAuthorDataSource extends BaseQuoteDataSource {

    private final Long authorId;

    public QuoteByAuthorDataSource(Long authorId, QuoteService quoteService) {
        super(quoteService);
    ...
    public void loadInitial(@NonNull LoadInitialParams params, @NonNull LoadInitialCallback<QuoteInfo> callback) {
       quoteService.getByAuthor(authorId)
